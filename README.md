We use here: [transitive joins](https://cube.dev/docs/joins#transitive-joins), geoJSON data, [granularity](https://cube.dev/docs/query-format#time-dimensions-format).
